...
function PopularProduct() {
  return (
    <div className="bg-white">
      <div className="w-11/12 mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 text-center pb-6">
